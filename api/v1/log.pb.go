...
const file_api_v1_log_proto_rawDesc = "" +
	"\n" +
	"\x10api/v1/log.proto\x12\x03api\"^\n" +
	"\x06Record\x12\x14\n" +
	...
	"\x04type\x18\x04 \x01(\rR\x04type\"5\n" +
	"\x0eProduceRequest\x12#\n" +
	"\x06record\x18\x01 \x01(\v2\v.api.RecordR\x06record\")\n" +
	"\x0fProduceResponse\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x04R\x06offset\"(\n" +
	"\x0eConsumeRequest\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x04R\x06offset\"6\n" +
	"\x0fConsumeResponse\x12#\n" +
	"\x06record\x18\x02 \x01(\v2\v.api.RecordR\x06record\"\x13\n" +
	"\x11GetServersRequest\";\n" +
	"\x12GetServersResponse\x12%\n" +
	"\aservers\x18\x01 \x03(\v2\v.api.ServerR\aservers\"P\n" +
	"\x06Server\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x19\n" +
	"\brpc_addr\x18\x02 \x01(\tR\arpcAddr\x12\x1b\n" +
	"\tis_leader\x18\x03 \x01(\bR\bisLeader2\xb8\x02\n" +
	"\x03Log\x126\n" +
	...
	"\rProduceStream\x12\x13.api.ProduceRequest\x1a\x14.api.ProduceResponse\"\x00(\x010\x01\x12?\n" +
	"\n" +
	"GetServers\x12\x16.api.GetServersRequest\x1a\x17.api.GetServersResponse\"\x00B!Z\x1fgithub.com/theoctave/godist;apib\x06proto3"
